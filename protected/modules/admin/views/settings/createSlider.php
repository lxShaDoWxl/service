...
<div class="scrollable">
    <div class="tab" id="tab-3">
        <form method="post" action="<?php echo CHtml::normalizeUrl(array('settings/slider', 'action'=>'save'))?>" class="modal">
            <table>
                <tbody>
                <tr>
                    <td>Ссылка:</td>
                    <td><input type="text" class="input wide" name="url" ></td>
                </tr>
                <tr>
                    <td>Позиция:</td>
                    <td><input type="text" class="input" name="position" ></td>
                </tr>
                <tr>
                    <td>
                        <div class="step-right">
                            ...
                            <input class="input" name="img" type="hidden" id="img" >
