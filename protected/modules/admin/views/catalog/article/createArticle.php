...
<div class="scrollable">
    ...
    <form method="post" action=" <?= CHtml::normalizeUrl(array('catalog/savearticle','id'=>'new'))?>" class="modal">
        <input name="cid" value="<?= $cat_id ?>" type="hidden">
        ...
        <table class="step-right">
				...
				<td>
					<select name="archive">
						...
						<? foreach($archives as $archive): ?>
						    <option value="<?=$archive->id?>" ><?=$archive->stats().' №'.$archive->number;?></option>
						<? endforeach ?>
					</select>
				</td>
			</tr>
            <tr>
                ...
                <td><input class="input wide" name="date" type="date" required id="date"></td>
                <td></td>
            </tr>
            <tr>
		...
		<div class="tab" id="tab-3">
			<table class="step-right">
				<tr>
					<td><strong>Название:</strong></td>
					<td><input class="input wide" name="title_en" type="text"  id="title"></td>
					<td></td>
				</tr>
				<tr>
					<td><strong>Короткое описание:</strong></td>
				...
				<tr>
					<td colspan="3">
						<textarea name="small_description_en" class="input wide"></textarea>
					</td>
				</tr>
				<tr>
					<td><strong>Полное описание:</strong></td>
				...
				<tr>
					<td colspan="3">
						<textarea class="input wide" name="full_description_en"></textarea>
					</td>
				</tr>
		...
		<div class="tab" id="tab-4">
			<table class="step-right">
				<tr>
					<td><strong>Название:</strong></td>
					<td><input class="input wide" name="title_kz" type="text"  id="title"></td>
					<td></td>
				</tr>
				<tr>
					<td><strong>Короткое описание:</strong></td>
				...
				<tr>
					<td colspan="3">
						<textarea name="small_description_kz" class="input wide"></textarea>
					</td>
				</tr>
				<tr>
					<td><strong>Полное описание:</strong></td>
				...
				<tr>
					<td colspan="3">
						<textarea class="input wide" name="full_description_kz"></textarea>
					</td>
				</tr>
