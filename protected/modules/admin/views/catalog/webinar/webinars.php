	...
	<ul>
		...
		<div class="sort-cat">
			<?php foreach ($themes as $theme): ?>
				<div class="category ajax-filter-category" data-id="<?= $theme->id ?>" data-type="category">
					<li class="shower" data-show=".cat-<?= $theme->id ?>">
						<a class="title"><?= $theme->title ?> </a>
						<a class="icon pull-right font-small pad5 confirm-delete" href="<?php echo CHtml::normalizeUrl(array('catalog/DeletedThemeWebinar','id'=>$theme->id))?>">g</a>
						<a class="icon pull-right font-small pad5 ajax-load" data-page="<?php echo CHtml::normalizeUrl(array('catalog/ThemeWebinar','id'=>$theme->id))?>" href="#i">i</a>
						<a class="icon pull-right font-small pad5 ajax-load" data-page="<?php echo CHtml::normalizeUrl(array('catalog/Webinar','theme_id'=>$theme->id))?>" href="#g">+</a>
					</li>
				</div>
			<?php endforeach ?>
		</div>

		<li class="create"><a class="ajax-load"  href="#create" data-page=" <?php echo CHtml::normalizeUrl(array('catalog/ThemeWebinar'))?>"> + Добавить</a></li>
	</ul>
...
<script type="text/javascript">
	...
	$(function() {
		...
		function composeFilter() {
			...
			$.post('<?php echo CHtml::normalizeUrl(array('catalog/filterWebinar'))?>',{filter:newHash},function(data){
				$("#items").html(data);
				if (data == ""){
