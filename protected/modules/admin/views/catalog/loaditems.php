<?php foreach ($items as $item): ?>
	<tr>
		<td> <div class="icon50"><img src=" <?= $this->baseUrl . $item->img() ?>" class="round50"></div> </td>
		<td> <a class="ajax-load" href="#edit" data-page="<?php echo CHtml::normalizeUrl(array('catalog/editArticle','id'=>$item->id))?>"><?= $item->title ?></a> </td>
		...
		<td class="skip"> 
			<div class="btn-group">
				<a class="btn btn-green icon ajax-load" href="#edit" data-page="<?php echo CHtml::normalizeUrl(array('catalog/editArticle','id'=>$item->id))?>">i</a>
				<a class="btn btn-green icon confirm-delete" href="<?php echo CHtml::normalizeUrl(array('catalog/deleteArticle','id'=>$item->id))?>">g</a>
			</div>
		</td>
	</tr>
<?php endforeach ?>	
